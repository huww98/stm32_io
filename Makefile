##########################################################################################################################
# File automatically-generated by tool: [projectgenerator] version: [3.17.1] date: [Fri Nov 11 11:00:02 CST 2022]
##########################################################################################################################
...
$(BUILD_DIR)/version.h: FORCE | $(BUILD_DIR)
	./GIT-VERSION-GEN $@
...
#######################################
# generate fonts
$(BUILD_DIR)/fonts.cpp: fonts/*.bdf fonts/make_fonts.py | $(BUILD_DIR)
...
$(BUILD_DIR)/%.o: %.cpp Makefile | $(BUILD_DIR) $(BUILD_DIR)/version.h
	$(CC) -c $(CXXFLAGS) $< -o $@
