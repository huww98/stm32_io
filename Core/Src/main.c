...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, LED0_Pin|LED1_Pin|LED2_Pin|LED3_Pin
                          |OLED_PWR_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, OLED_RE__Pin|SER_Pin|RCK_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : SER_Pin RCK_Pin */
  GPIO_InitStruct.Pin = SER_Pin|RCK_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  ...
  /*Configure GPIO pin : FOCUS_Pin */
  GPIO_InitStruct.Pin = FOCUS_Pin;
  ...
  /*Configure GPIO pins : SHUTTER_IN_Pin FOCUS_IN_Pin */
  GPIO_InitStruct.Pin = SHUTTER_IN_Pin|FOCUS_IN_Pin;
